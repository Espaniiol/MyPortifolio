        ...
        <div className="p-7">
          ...
          <div className="flex gap-3">
            ...
            <a href={p.demo} target="_blank" rel="noreferrer"
              className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 hover:bg-white hover:text-black"
              style={{ border: '1px solid var(--c-t20)', color: 'var(--c-text)' }}>Demo →</a>
          </div>
        </div>
      </div>
    </div>
              ...
              <div key={p.id}
                ...
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="flex gap-2">
                    {[p.github, p.demo].map((href, i) => (
                      <a key={i} href={href} onClick={e => e.stopPropagation()}
